<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="prjct1.UserHome" %>
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a class="active" href="Login.aspx">Login</a>
                 <%-- <ul>
...
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" BackColor="#6699FF" OnClick="Button1_Click" Text="Search" Width="125px" />
                </td>
                <td>&nbsp;</td>
                <td class="auto-style5">&nbsp;</td>
                <td>&nbsp;</td>
                        ...
                        <ItemTemplate>
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:ImageButton ID="ImageButton1" runat="server" Height="241px" ImageUrl='<%# Eval("Cat_image") %>' Width="278px" CommandArgument='<%# Eval("Cat_id") %>' OnCommand="ImageButton1_Command" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("Cat_name") %>' ForeColor="Black"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("Cat_description") %>' ForeColor="Black"></asp:Label>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
