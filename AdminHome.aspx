<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome.aspx.cs" Inherits="prjct1.AdminHome" %>
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Italic="True" Font-Underline="True" ForeColor="#0000CC" Text="Welcome to Admin Home"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    &nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" runat="server" ForeColor="#CC0099" PostBackUrl="~/AdCategory.aspx" Font-Bold="True">Category</asp:LinkButton>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton ID="LinkButton2" runat="server" ForeColor="#CC0099" PostBackUrl="~/AdProduct.aspx" Font-Bold="True">Product</asp:LinkButton>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" ForeColor="#CC0099" PostBackUrl="~/viewpaidpdctdetails.aspx">View Paid Product Details</asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" ForeColor="#CC0099" PostBackUrl="~/FeedbackandReply.aspx">Feedback &amp; Reply</asp:LinkButton>
                    </td>
