<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdProduct.aspx.cs" Inherits="prjct1.AdProduct" %>
...
<!-- end footer -->
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Choose Category" ForeColor="Black"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label10" runat="server" ForeColor="Black" Text="Stock"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text="Photo" ForeColor="Black"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="Description" ForeColor="Black"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Add" BackColor="#6699FF" ForeColor="Black" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Pro_id" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                        <Columns>
                            <asp:BoundField DataField="Cat_name" HeaderText="Category" />
                            <asp:BoundField DataField="Pro_name" HeaderText="ProductName" />
                            <asp:BoundField DataField="pro_qty" HeaderText="Stock" />
                            ...
                            <asp:CommandField ShowDeleteButton="True" HeaderText="Please select" />
                            <asp:CommandField HeaderText="Please select" ShowSelectButton="True" />
                        </Columns>
                    </asp:GridView>
                </td>
                <td>&nbsp;</td>
                ...
                <td>
                    <asp:Panel ID="Panel1" runat="server" Visible="False">
                        <table class="auto-style1">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label11" runat="server" ForeColor="Black" Text="Image"></asp:Label>
                                </td>
                                <td>
                                    <asp:Image ID="Image1" runat="server" Height="142px" Width="271px" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label12" runat="server" ForeColor="Black" Text="Description"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label13" runat="server" ForeColor="Black" Text="Price"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label14" runat="server" ForeColor="Black" Text="Stock"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label15" runat="server" ForeColor="Black" Text="Status"></asp:Label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Label ID="Label9" runat="server" Text="Label" Visible="False" ForeColor="Black"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
