<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewpdct.aspx.cs" Inherits="prjct1.viewpdct" %>
        ...
        <div>
            <table class="w-100">
                ...
                <tr>
                    ...
                    <asp:Image ID="Image1" runat="server" Height="305px" Width="346px" />
                    </td>
...
&nbsp;<asp:Label ID="Label2" runat="server" Text="Label" ForeColor="Black"></asp:Label>
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td>
                    <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter the quantity"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td class="auto-style2">&nbsp;</td>
                    <td>
                    <asp:Button ID="Button1" runat="server" Text="Add to cart" BackColor="#3366FF" ForeColor="Black" OnClick="Button1_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" PostBackUrl="~/UserHome.aspx" Text="Continue" BackColor="#3366FF" ForeColor="Black" OnClick="Button2_Click" />
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
