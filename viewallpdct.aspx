<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewallpdct.aspx.cs" Inherits="prjct1.viewallpdct" %>
                        ...
                        <asp:DataList ID="DataList1" runat="server" RepeatColumns="2">
                            <ItemTemplate>
                                <table class="auto-style1">
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="ImageButton2" runat="server" Height="156px" ImageUrl='<%# Eval("Photo") %>' Width="175px" CommandArgument='<%# Eval("Pro_id") %>' OnCommand="ImageButton2_Command" />
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("Pro_name") %>' ForeColor="Black"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("Price") %>' ForeColor="Black"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("Pro_description") %>' ForeColor="Black"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
