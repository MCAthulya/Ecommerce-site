<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdCategory.aspx.cs" Inherits="prjct1.AdCategory" %>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label8" runat="server" ForeColor="Black" Text="Name"></asp:Label>
                    </td>
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Label ID="Label6" runat="server" Text="Photo" ForeColor="Black"></asp:Label>
                    </td>
                    <td class="auto-style3">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Cat_id" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging">
                            <Columns>
                                <asp:BoundField DataField="Cat_name" HeaderText="Name" />
                                <asp:ImageField DataImageUrlField="Cat_image" HeaderText="Photo">
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td class="auto-style3">
                        <asp:Label ID="Label5" runat="server" Text="Label" Visible="False" ForeColor="Black"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                            ...
                            <table class="auto-style1">
                                ...
                                <tr>
                                    <td class="auto-style20">
                                        <asp:Label ID="Label9" runat="server" ForeColor="Black" Text="Photo"></asp:Label>
                                    </td>
                                    <td>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Image ID="Image1" runat="server" Height="120px" Width="239px" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                                ...
                                <tr>
                                    <td class="auto-style14">
                                        <asp:Label ID="Label10" runat="server" ForeColor="Black" Text="Description"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style20">&nbsp;</td>
                                    <td>
                                        &nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="Button2" runat="server" BackColor="#6699FF" ForeColor="Black" OnClick="Button2_Click" Text="update" />
                                    </td>
                                    <td class="auto-style19">&nbsp;</td>
                                    <td class="auto-style11">&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td class="auto-style20">&nbsp;</td>
                                    <td>
                                        &nbsp;&nbsp;&nbsp; &nbsp;<asp:Label ID="Label7" runat="server" ForeColor="Black" Text="Label" Visible="False"></asp:Label>
                                    </td>
                                    <td class="auto-style19">&nbsp;</td>
                                    <td class="auto-style11">&nbsp;</td>
                                    <td>&nbsp;</td>
